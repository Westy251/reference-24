...
int main(){
    ...
    uint8_t ciphertext[] = {0x2B, 0x59, 0x97, 0x53, 0x82, 0xCC, 0xE3, 0x0A, 0xC8, 0x3A, 0x52, 0x1A, 0xEF, 0xF6, 0x06, 0x1A, 0xE5, 0x42, 0x79, 0xB9, 0x81, 0xED, 0x9E, 0xDA, 0xC2, 0xFB, 0x0B, 0x26, 0x49, 0x08, 0xD9, 0xCD};
